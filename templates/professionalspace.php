    ...
    <div class="container-fluid my-4">
        <div class="row justify-content-center">
            <div class="col-auto mb-4">
                <a <?php if ($classRole=="admin"){?>href="/UserManager/display"<?php } ?>>
                    <figure class="<?php echo $classRole ?>">
            ...
            <div class="col-auto mb-4">
                <a <?php if ($classRole=="admin"){?>href="/AnimalManager/display"<?php } ?>>
                    <figure class="<?php echo $classRole ?>">
            ...
            <div class="col-auto mb-4">
                <a <?php if ($classRole=="admin"){?>href="/HabitatManager/display"<?php } ?>>
                    <figure class="<?php echo $classRole ?>">
            ...
            <div class="col-auto mb-4">
                <a <?php if (($classRole == "admin")|($classRole=="employe")) {?>href="/ServiceManager/display"<?php } ?>>
                    <figure <?php if ($classRole == "employe"){?>class="admin"<?php } else { ?>class="<?php echo $classRole ?>" <?php } ?>>
            ...
            <div class="col-auto mb-4">
                <a <?php if ($classRole == "admin"){?>href="/HoursManager/display"<?php } ?>>
                    <figure class="<?php echo $classRole ?>">
            ...
            <div class="col-auto mb-4">
                <a <?php if (($classRole == "admin")|($classRole == "employe")) {?>href=""<?php } ?>>
                    <figure <?php if ($classRole == "employe"){?>class="admin"<?php } else { ?>class="<?php echo $classRole ?>" <?php } ?>>
            ...
            <div class="col-auto mb-4">
                <a <?php if (($classRole == "admin")|($classRole == "veterinaire")) {?>href="test"<?php } ?>>
                    <figure <?php if ($classRole == "veterinaire"){?>class="admin"<?php } else { ?>class="<?php echo $classRole ?>" <?php } ?>>
            ...
            <div class="col-auto mb-4">
                <a <?php if (($classRole == "admin")|($classRole == "veterinaire")) {?>href=""<?php } ?>>
                    <figure <?php if ($classRole == "veterinaire"){?>class="admin"<?php } else { ?>class="<?php echo $classRole ?>" <?php } ?>>
            ...
            <div class="col-auto mb-4">
                <a <?php if ($classRole == "admin"){?>href=""<?php } ?>>
                    <figure class="<?php echo $classRole ?>">
